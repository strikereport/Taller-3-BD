...
DELETE FROM EMPLEADO 
  ...
  -- RE:
    Informe de error -
    ORA-02292: restricción de integridad (SYSTEM.FKEMP_PROY362421) violada - registro secundario encontrado

--10
DELETE FROM PROYECTO WHERE CODIGO = '2'
  --RE:
    Informe de error -
    ORA-02292: restricción de integridad (SYSTEM.FKEMP_PROY902692) violada - registro secundario encontrado
