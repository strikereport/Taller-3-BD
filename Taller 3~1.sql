...
--TABLA PARA EL PROYECTO FORANEO
...
PRIMARY KEY (CODIGO),
--CLAVE FORANEA
CONSTRAINT FK_RUT_JEFE
FOREIGN KEY (RUT_JEFE) REFERENCES EMPLEADO(RUT)
);
...
--LLAVE FORANEA
CONSTRAINT FK_CODIGO_EMP_PROY
FOREIGN KEY (CODIGO_EMP_PROY) REFERENCES PROYECTO(CODIGO),
CONSTRAINT FK_RUT_EMP_PROY
FOREIGN KEY (RUT_EMP_PROY) REFERENCES EMPLEADO(RUT)
);
